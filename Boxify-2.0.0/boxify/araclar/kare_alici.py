...
QCheckBox::indicator:checked { background: #0d7acc; }
"""
...
class MainWindow(QMainWindow):
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        range_frame = QFrame()
        range_frame.setStyleSheet("QFrame { border: 1px solid #3a3a3a; border-radius:4px; }")
        ...
        self.extract_btn.setStyleSheet(
            "background:#1b5e20; color:white; font-weight:bold; padding:8px;")
