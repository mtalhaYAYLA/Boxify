...
3.1.0: Eğitim aracı (kendi modelinden ince ayar, cihaz seçimi, erken durdurma,
       canlı kayıp/mAP eğrisi, eğitim öncesi sızıntı denetimi) + veri seti
       birleştirme ve sınıf eşleme + Labelapp'in sızıntılı bölmesinin
       düzeltilmesi + platforma göre kurulum (macOS .app, Linux, Windows).
