...
class MainWindow(QMainWindow):
    ...
    def _build_toolbar(self) -> QFrame:
        ...
        def btn(text, slot, tip="", color=""):
            ...
            if color:
                b.setStyleSheet(
                    f"background:{color}; color:#f5f8fb; font-weight:bold; padding:5px 14px;")
    ...
    def _build_controls(self) -> QFrame:
        ...
        self.preview_lbl.setStyleSheet("color:#275b8c; font-size:11px;")
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        self.range_lbl.setStyleSheet("color:#2e6da4; font-family:monospace; font-size:11px;")
        ...
        self.mode_hint.setStyleSheet("color:#6b7686; font-size:10px;")
        ...
        self.clip_count_lbl.setStyleSheet("color:#6b7686; font-size:11px;")
