...
KALIPLAR = [(re.compile(d), k) for d, k in [
    ...
    # ffmpeg eksik uyarısı: "Eksik: ffmpeg, ffprobe — kırpma devre dışı. Kurulum: …"
    (r"^Eksik: (.+) — kırpma devre dışı\. Kurulum: (.+)$",
     "Missing: {} — trimming disabled. Install with: {}"),
    (r"^Eksik: (.+) — kare çıkarma devre dışı\. Kurulum: (.+)$",
     "Missing: {} — frame extraction disabled. Install with: {}"),
    (r"^ffmpeg bulunamadı\. Kurulum: (.+)$",
...
SOZLUK = {
    ...
    "ffmpeg bulunamadı": "ffmpeg not found",
    "Kurulum: brew install ffmpeg": "Install with: brew install ffmpeg",
    "Kurulum: winget install ffmpeg": "Install with: winget install ffmpeg",
    "Kurulum: sudo apt install ffmpeg": "Install with: sudo apt install ffmpeg",
    "ffmpeg hatası oluştu.": "ffmpeg reported an error.",
