...
class PreviewLabel(QLabel):
    ...
    def __init__(self):
        super().__init__("Önizleme")
        self.setAlignment(Qt.AlignCenter)
        self.setStyleSheet("background:#1b1b1b; color:#666; border:1px solid #3a3a3a;")
...
class MainWindow(QMainWindow):
    ...
    def _build_file_list(self) -> QWidget:
        ...
        self.file_count_lbl.setStyleSheet("color:#777; font-size:11px;")
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        self.model_info_lbl.setStyleSheet("color:#8f8f8f; font-size:11px;")
        ...
        self.stats_lbl.setStyleSheet("color:#8f8f8f; font-size:11px;")
